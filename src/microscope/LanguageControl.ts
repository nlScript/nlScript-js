    ...
    initParser(): Parser {
        ...
        parser.defineSentence(
            ...
            e => {
                ...
                start.setHours(this.globalStart.getHours());
                start.setMinutes(this.globalStart.getMinutes());
                start.setSeconds(this.globalStart.getSeconds());
                start.setMilliseconds(this.globalStart.getMilliseconds());
